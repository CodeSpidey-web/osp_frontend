...
export default function GoogleReviewsSection() {
  ...
  return (
    <section className="py-12 bg-slate-50/70 text-slate-800 font-sans my-6">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Top Header Badge & Title */}
        <div className="text-center mb-6">
          <div className="inline-block px-4 py-1.5 rounded-full text-[11px] font-extrabold text-emerald-800 bg-emerald-100 border border-emerald-200 uppercase tracking-wider mb-3 shadow-xs">
            VERIFIED REVIEWS
          </div>
        ...
        <div className="relative px-1 sm:px-4">
          ...
          <div
            ...
            className="absolute -left-2 sm:-left-5 top-1/2 -translate-y-1/2 z-20 hover:scale-105 active:scale-95 transition-transform"
            style={{
              width: "36px",
              height: "36px",
              minWidth: "36px",
          ...
          <div
            ...
            className="absolute -right-2 sm:-right-5 top-1/2 -translate-y-1/2 z-20 hover:scale-105 active:scale-95 transition-transform"
            style={{
              width: "36px",
              height: "36px",
              minWidth: "36px",
