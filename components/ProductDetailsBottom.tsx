                ...
                <div className="tab-content">
                  ...
                  <div aria-labelledby="rbt-specification-tab" className="tab-pane fade" id="rbt-specification" role="tabpanel">
                    <div className="rbt-prd-single-specification-info">
                      <div className="rbt-single-specification">
                        <label className="b1 title">Product ID :</label>
                        <div className="rbt-specification-content">
                          <span className="desc">{product.id}</span>
                        </div>
                      </div>
                      {product.collection && (
                        <div className="rbt-single-specification">
                          <label className="b1 title">Collection :</label>
                          <div className="rbt-specification-content">
                            <span className="desc">{product.collection.title}</span>
                          </div>
                        </div>
                      )}
                      {product.subtitle && (
                        <div className="rbt-single-specification">
                          <label className="b1 title">Subtitle :</label>
                          <div className="rbt-specification-content">
                      ...
                      {product.variants?.map((v) => (
                        <div key={v.id} className="rbt-single-specification">
                          <label className="b1 title">{v.title} :</label>
                          <div className="rbt-specification-content">
                            <span className="desc">{v.sku || v.id}</span>
                          </div>
                        </div>
                      ))}
                    </div>
                  ...
                  <div aria-labelledby="rbt-reviews-tab" className="tab-pane fade" id="rbt-reviews" role="tabpanel">
                    <div className="rbt-product-single-reviews-area">
                      <p className="b1">Reviews are not available yet.</p>
                    </div>
                  </div>
                </div>
              </div>
